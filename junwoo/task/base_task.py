...
from dist_utils import get_rank, get_world_size, is_main_process, is_dist_avail_and_initialized
from logger import MetricLogger, SmoothedValue
from registry import registry
from data_utils import prepare_sample
...
class BaseTask:
    ...
    def _train_inner_loop(
        ...
        for i in metric_logger.log_every(range(iters_per_epoch), log_freq, header):
            ...
            text = subgraph_texts[i % len(subgraph_texts)]
            samples = {
